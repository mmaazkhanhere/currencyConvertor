    ...
    do {
        ...
        if (CurrencySelector.CurrencySelector == 'US Dollar (USD)') {
            if (CurrencySelector.CurrencySelector == 'US Dollar (USD)' && CurrencyChanger.CurrencyChanger == 'US Dollar (USD)') {
                ...
                console.log(`${amount.amount} USD in GBP is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} USD in SAR is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} USD in EUR is: ${amountConverted.toFixed(3)}`);
            }
        }
            ...
            if (CurrencySelector.CurrencySelector == 'Pound (GBP)' && CurrencyChanger.CurrencyChanger == 'US Dollar (USD)') {
                ...
                console.log(`${amount.amount} GBP in USD is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} GBP in SAR is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} GBP in EUR is: ${amountConverted.toFixed(3)}`);
            }
        }
            ...
            if (CurrencySelector.CurrencySelector == 'Riyal (SAR)' && CurrencyChanger.CurrencyChanger == 'US Dollar (USD)') {
                ...
                console.log(`${amount.amount} SAR in USD is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} SAR in GBP is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} SAR in EUR is: ${amountConverted.toFixed(3)}`);
            }
        }
            ...
            if (CurrencySelector.CurrencySelector == 'Euro (EUR)' && CurrencyChanger.CurrencyChanger == 'US Dollar (USD)') {
                ...
                console.log(`${amount.amount} EUR in USD is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} EUR in GBP is: ${amountConverted.toFixed(3)}`);
            }
                ...
                console.log(`${amount.amount} EUR in SAR is: ${amountConverted.toFixed(3)}`);
            }
